...
export default function Card(props) {
  ...
  const handleClick = () =>{
    ...
    setNewItem('');
    setShowAdd(true);
    fetch("https://kanban-sri.onrender.com/api/post", {
      method: 'POST',
      headers: {
  ...
  const handleEdit = (task, toEdit) =>{
    ...
    fetch(`https://kanban-sri.onrender.com/api/edit/${props.cardName}/${toEdit}`, {
  ...
  const handleDelete = (taskName) => {
    ...
    fetch(`https://kanban-sri.onrender.com/api/board/${props.cardName}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        // Add any other headers your API requires
